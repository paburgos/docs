...
14. Expand the Customer option from the main menu, click on Customer, load its home page, and click on the New button:

<img  src="/images/balance/basics-customer-new.png">

15. Three mandatory pieces of information must be added: in Basic Information, you must enter the name; in Address, the address; and in Contacts, at least one contact. The other fields are optional.
