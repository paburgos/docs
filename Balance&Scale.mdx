...
Access your URL https://lticalibration-staging.azurewebsites.net/ and log in with the username Alice 
<Info>
  Access credentials will be provided as needed
</Info>


<img  src="/images/Balance/1.jpg"

Click on the Basics option located in the left side menu of the screen, expand the submenu, and select the Manufacturer option to load the query table:

<img  src="/images/Balance/basics-manufacturer.jpg"
...
Click on the New button and load the form to create it:
